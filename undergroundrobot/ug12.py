...
def readbno(q,headingoffset, samplerate,errormeanheadingrad,errormeanpitchrad):    
        global timevar
        global xloclist
        global yloclist
        global zloclist
...
#                 meanheading, meanroll, meanpitch))         
                meanheadingrad=meanheading*pi/180
                meanpitchrad=meanpitch*pi/180
...
#    headingoffset=0
    ...
    p.start()
    while True:
        readbno(q,headingoffset,samplerate,errormeanheadingrad,errormeanpitchrad)
