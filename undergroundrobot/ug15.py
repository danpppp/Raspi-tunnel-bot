...
#        pitch=0
    ...
    if clkState != clkLastState:
        ...
        if counter>countermax:
            ...
            if len(headinglist)>200:
                nforquickness=round(len(headinglist)/100)
                headinglist=headinglist[0::nforquickness]
                rolllist=rolllist[0::nforquickness]
                pitchlist=pitchlist[0::nforquickness]
